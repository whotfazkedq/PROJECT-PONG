...
if (confirm_key || confirm_click) {
    switch (selected) {
        case 0: if (wait_active) { anomaly_fnd(3, "patience is a virtue"); } else { room_goto(CONNECT_RM_SCND_ROOM); } break;
        case 1: global.options_return = "menu"; room_goto(CONNECT_RM_WEIRD_ADJUSTMENT); break;
